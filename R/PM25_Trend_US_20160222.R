...
All_PM25_4$Period=cut(as.numeric(substr(All_PM25_4$Date,1,4)),c(1990,seq(1995,2017,5),2019),
	labels=c('1990-1994','1995-1999','2000-2004','2005-2009','2010-2014', '2015-2018'),right=FALSE,include.highest=TRUE)

title=substitute(paste(PM[2.5],' Trend from 1995 to 2018 in US'))
...
All_PM25_region5$Period=cut(as.numeric(substr(All_PM25_region5$Date,1,4)),c(1990,seq(1995,2017,5),2019),
	labels=c('1990-1994','1995-1999','2000-2004','2005-2009','2010-2014', '2015-2018'),right=FALSE,include.highest=TRUE)

title=substitute(paste(PM[2.5],' Trend from 1990 to 2018 in US EPA Region ',nn1),list(nn1=i))
Y_title=substitute(paste(PM[2.5],' Value'))
